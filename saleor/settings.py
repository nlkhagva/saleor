...
_DEFAULT_CLIENT_HOSTS = "localhost,127.0.0.1,192.168.1.2,192.168.1.57"
...
DATABASES = {
    "default": dj_database_url.config(
        default="postgres://saleor:saleor@localhost:5432/unurshop_db", conn_max_age=600
    )
}
...
ALLOWED_HOSTS = get_list(os.environ.get("ALLOWED_HOSTS", "localhost,192.168.1.57,ushop-core.reactx.space"))
