...
_DEFAULT_CLIENT_HOSTS = "localhost,127.0.0.1,192.168.1.28"
...
DATABASES = {
    "default": dj_database_url.config(
        default="postgres://masteruser:MindPoint(3)@database-2.cx2db9laertr.eu-central-1.rds.amazonaws.com:5432/unurshop_db", conn_max_age=600
    )
}
...
# SECRET_KEY = '()4+wn$v$&=rl1z-i$5czb*gwiy2$1h_mu8k66td+n)w640n*b'
...
DEFAULT_COUNTRY = os.environ.get("DEFAULT_COUNTRY", "MN")
...
ALLOWED_HOSTS = get_list(os.environ.get("ALLOWED_HOSTS", "localhost,192.168.1.28,ushop-core.reactx.space"))
